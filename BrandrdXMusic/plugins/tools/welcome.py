...
๏ 𝐌𝐀𝐃𝐄 𝐁𝐘 ➠ [- Ｔ ʜ 𝛖 ꪀ ᴅ 𝛆 ᰻⃪᱂ 📿](https://t.me/lll_THUNDERXD_lll)
➖➖➖➖➖➖➖➖➖➖➖
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/THUNDERXD_MUSIC_BOT?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
